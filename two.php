                ...
                <article class="single-blog-post">
                 ...
                 <div class="project-meta">
                                        <ul class="project-metadata">
                                             <li><strong>Client:</strong>Mr. shyamal Bandara</li> 
                                            <li><strong>Location:</strong>Kurunagala Town</li>
        ...
        <div class="container-fluid">
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/1.webp" data-lightbox="image-1"
                ><div class="thumb">
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/1.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/2.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/2.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/3.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/3.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/4.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/4.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/5.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/5.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/6.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/6.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="portfolio-item">
              <a href="img/portfolio/commercial/two/7.webp" data-lightbox="image-1"
                ><div class="thumb">
                  <div class="hover-effect">
                    <div class="hover-content">
                      <!-- <h1>Riverside <em>Courtyard</em></h1>
                  ...
                  <div class="image">
                    <img src="img/portfolio/commercial/two/7.webp" alt="courtyard image" />
                  </div></div
              ></a>
            </div>
          </div>
